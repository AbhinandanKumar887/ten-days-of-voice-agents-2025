...
# 🛡 "Mr. Abhinandan kumar's Bank" - Fraud Detection & Resolution (sqlite backend)
# ======================================================
...
def get_db_path():
    return os.path.join(os.path.dirname(_file_), DB_FILE)
...
class FraudAgent(Agent):
    def _init_(self):
        super()._init_(
            instructions="""
            You are 'Alex', a Fraud Detection Specialist at Mr abhinandhan Bank.
