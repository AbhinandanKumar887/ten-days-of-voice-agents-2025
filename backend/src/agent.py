...
# Default FAQ data for "Rohon Store"
DEFAULT_FAQ = [
    {
    ...
    },
    {
        ...
        "answer": "Yes! Mr. Rohon  releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
def load_knowledge_base():
    ...
    try:
        path = os.path.join(os.path.dirname(_file_), FAQ_FILE)
...
async def submit_lead_and_end(
    ...
    db_path = os.path.join(os.path.dirname(_file_), LEADS_FILE)
...
class SDRAgent(Agent):
    def _init_(self):
        super()._init_(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for abhinandan kumar'.
            ...
            🚫 *RESTRICTIONS:*
            - If you don't know an answer, say "I'll check with Mr. abhinandan kumar and email you." (Don't hallucinate prices).
            """,
